...
def run_ragas_eval(rag_results: list, version: str) -> dict:
    ...
    # Rút gọn xuống 10 câu hỏi để tránh Rate Limit / Timeout của API
    eval_qa_pairs = QA_PAIRS[:10]
    ...
    # TODO: Khởi tạo dataset từ các samples
    print("  Đang tạo EvaluationDataset...")
    ...
    # TODO: Gọi hàm evaluate() với các metrics đã import
    print("  Đang chạy ragas.evaluate()...")
    result = evaluate(
        dataset,
        ...
        run_config=RunConfig(max_workers=2, timeout=120, max_retries=15)
    )
